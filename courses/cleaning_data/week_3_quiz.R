...
download.file(fileUrl, destfile = "./data/week3_data.csv", method = "curl")
week3_data <- read.csv("./data/week3_data.csv")

#question 1 households on greater than 10 acres who sold more than 10K worth of agriculture products

agricultureLogical <- week3_data$ACR == 3 & week3_data$AGS == 6
